...
export function InboxTab() {
  ...
  const { data: threads = [], isLoading: threadsLoading, isError: threadsError, refetch: refetchThreads } = useQuery<Thread[]>({
    ...
    <div className="flex h-[calc(100vh-112px)]">
      ...
      <div className="w-80 border-r border-slate-200 flex flex-col bg-white">
        ...
        <div className="flex-1 overflow-y-auto">
          {threadsError ? (
            <ErrorState message="Failed to load conversations." onRetry={refetchThreads} />
          ) : threadsLoading ? (
